	...
	public function __construct()
	{
	 ...
	 /** for expnse_info table **/ 
		...
		function all_today_transaction_expense()
		{
			...
			$this->db->select('transaction_info.transaction_id,transaction_info.transaction_purpose,transaction_info.amount,transaction_info.date,type_info.type_type,expense_info.expense_details');
