...
class My_variables_model extends CI_model
{
	  ...
	  function my_variables()
	  {
	  	/*  $data['expense_type']= array(
			    ...
			    'refreshment_bill' => 'Refreshment Bill',
			    'office_rent' => 'Office Rent',
			    'transport_allowance' => 'Transport Allowance'
			  
	    );				  
	    $query = $this -> db -> get('type_info');			  
	    $data[''] =  'Select An Expense Type';
		$data2[''] = 'Select An Expense Type';
		foreach ($query-> result() as $field)
	    {
			  $data2[$field -> type_type] = $field -> type_type;
      ...
      function fatch_gift_mode()
      {
		   ...
		   $data = array(
			    ''  => 'Select A Mode',
			    // 'cash' => 'Cash',
			     base_url().'index.php/account_controller/transaction_entry/transfer/'.$seg.'/cash' => 'Cash',
			     base_url().'index.php/account_controller/transaction_entry/transfer/'.$seg.'/cheque' => 'Cheque'
            );
		    return $data;
	  }
	  ...
	  function fatch_cheque_type()
	  {
			$data = array(
					''  => 'Select A Type',
					base_url().'index.php/account_controller/cheque_entry/in' => 'In',
					base_url().'index.php/account_controller/cheque_entry/out' => 'Out',
					base_url().'index.php/account_controller/cheque_entry/transfer' => 'Transfer',
			);
			return $data;
	  }
	  ...
	  function fatch_all_cheque_change_status_purpose($total_paid, $cheque_amount,$cheque_status)
	  {
			...
			if($this -> uri -> segment(1) == 'account_controller')
			{
				...
				if($cheque_status == 'recovering' || $cheque_status == 'recovered')
				{
					$data = array(
							''  => 'Select A Status',
							//base_url().'index.php/account_controller/change_cheque_status_entry/'.$segment_3.'/honore' => 'Honore',
							//base_url().'index.php/account_controller/change_cheque_status_entry/'.$segment_3.'/dishonore' => 'Dishonore',
							//base_url().'index.php/account_controller/change_cheque_status_entry/'.$segment_3.'/changeDate' => 'Change Cheque Date',
					);
					return $data;
				}
			...
			else if( $this -> uri -> segment(1) == 'report_controller' &&  $this -> uri -> segment(2) == 'all_cheque_detials' )
			{
				$data = array(
						''  => 'Select A Status',
						base_url().'index.php/report_controller/all_cheque_detials/dishonored/bystatus' => 'Dishonore',
						base_url().'index.php/report_controller/all_cheque_detials/honored/bystatus' => 'Honore',
						base_url().'index.php/report_controller/all_cheque_detials/pending/bystatus' => 'Pending',
			...
			else
			{
				$data = array(
						''  => 'Select A Status',
						base_url().'index.php/modify_controller/cheque_status_modify/'.$segment_3.'/changeDate' => 'Change Cheque Date',
						base_url().'index.php/modify_controller/cheque_status_modify/'.$segment_3.'/dishonore' => 'Dishonore',
						base_url().'index.php/modify_controller/cheque_status_modify/'.$segment_3.'/honore' => 'Honore',
						base_url().'index.php/modify_controller/cheque_status_modify/'.$segment_3.'/pending' => 'Pending',
	  ...
	  function select_cheque_mode()
	  {
		    $data = array(
			    ''  => 'Select A Mode',
			     base_url().'index.php/report_controller/all_cheque_detials/in/bymode' => 'In',
			     base_url().'index.php/report_controller/all_cheque_detials/out/bymode' => 'Out',
			     base_url().'index.php/report_controller/all_cheque_detials/ToBank/bymode' => 'To Bank',
			     base_url().'index.php/report_controller/all_cheque_detials/FromBank/bymode' => 'From Bank'
            );
		    return $data;
	  }
