<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed'); 
	class Web_model extends CI_model
	{
		...
		public function all_search_record_count($category_id) 
		{
			...
			$this -> db -> select('product_info.product_name,product_info.company_name,product_info.product_size,product_info.unit_name,product_info.image_url,bulk_stock_info.stock_amount,bulk_stock_info.general_unit_sale_price');
		...
		public function all_search_result($per_page,$category_id) 
		{
			...
			$this -> db -> select('product_info.product_id,product_info.product_name,product_info.product_name_bng,product_info.company_name,product_info.product_size,product_info.unit_name,product_info.image_ext,product_info.image_url,bulk_stock_info.stock_amount,bulk_stock_info.general_unit_sale_price');
			$this -> db -> from('product_info,bulk_stock_info');
			$this -> db -> where('product_info.product_id = bulk_stock_info.product_id');
			$this->db->where('product_info.catagory_name',$category_id);
