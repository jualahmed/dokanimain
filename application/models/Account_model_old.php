...
class Account_model extends CI_model{
	...
	public function __construct()
	{
	 ...
	 /** for expnse_info table **/ 
        function  create_expense()
		{
			...
			$payment_amount = $this -> input -> post('total_paid');
			...
			if($this -> input -> post('expense_type')==8)
			{
				$common_ledger = $this -> input -> post('employee_id');
				$new_expense_info_insert_data = array(
					'shop_id' =>$this->tank_auth->get_shop_id(), 
					'employee_id' => $common_ledger,
				...
				$this -> db -> insert('expense_info',$new_expense_info_insert_data);
				$ref_id = $this->db->insert_id();
			}
			else{
				$common_ledger = $this -> input -> post('service_provider_id');
				$new_expense_info_insert_data = array(
					'shop_id' =>$this->tank_auth->get_shop_id(), 
					'employee_id' => $common_ledger,
					'expense_type' => $this -> input -> post('expense_type'),				
		...
		function all_today_transaction_collection()
		{
			...
			$this->db->select('transaction_info.transaction_id,transaction_info.transaction_purpose,transaction_info.amount,transaction_info.date,customer_info.customer_name');
		...
		function all_today_transaction_purchase()
		{
			...
			$this->db->select('transaction_info.transaction_id,transaction_info.transaction_purpose,transaction_info.amount,transaction_info.date,distributor_info.distributor_name');
		...
		function all_today_transaction_expense()
		{
			...
			$this->db->select('transaction_info.transaction_id,transaction_info.transaction_purpose,transaction_info.amount,transaction_info.date,service_provider_info.service_provider_name,expense_info.expense_type');
			$this->db->from('transaction_info,service_provider_info,expense_info');
			$this->db->where('expense_info.service_provider_id=service_provider_info.service_provider_id');
			$this->db->where('transaction_info.ledger_id=service_provider_info.service_provider_id');
	...
	function all_investor()
	{
		...
		{
			$this->db->select('bank_book.*,transaction_info.ledger_id,bank_info.bank_name');
			$this->db->from('bank_book,transaction_info,bank_info');
			$this->db->where('bank_book.transaction_id = transaction_info.transaction_id');
		...
		public function get_sale_ledger_name($ledger_type)
		{
		...
		public function get_purchase_ledger_name($ledger_type)
		{
		...
		public function get_expense_ledger_name($ledger_type)
		{
			$this->db->select('type_info.*');
			$this->db->from('type_info,transaction_info,bank_book');
	...
	*****************************/
	...
	{
		$this->db->select('SUM(transaction_info.amount) as total_sale_amount,customer_info.customer_name,customer_info.customer_contact_no,customer_info.customer_address');
		$this->db->from('transaction_info,customer_info');			
		$this->db->where('transaction_info.transaction_purpose = "sale"');
		$this->db->where('transaction_info.ledger_id = customer_info.customer_id');
	...
	public function receipt_expense_total_amount_emp_wise($employee_id)
	{
		...
		$this->db->from('transaction_info,employee_info,type_info');			
		$this->db->where('transaction_info.transaction_purpose = "expense"');
    ...
    ******************************/ 
	...
	public function sale_total_amount($start,$customer_id)
	{
		...
		$this->db->from('transaction_info');			
		$this->db->where('(transaction_info.transaction_purpose = "sale" OR transaction_info.transaction_purpose = "sale_collection_deleted")');
	...
	public function sale_collection_total_amount($start,$customer_id)
	{
		...
		$this->db->from('transaction_info');			
		$this->db->where('((transaction_info.transaction_purpose="credit_collection" OR transaction_info.transaction_purpose="collection" OR transaction_info.transaction_purpose="sale_return"))');
		if($customer_id!=''){$this->db->where('transaction_info.ledger_id',$customer_id);}
		$this->db->where('transaction_info.date <',$start);
		$query_data = $this->db->get();
		return $query_data;
	...
	{
		$this->db->select('transaction_info.transaction_id,transaction_info.transaction_purpose,transaction_info.amount,transaction_info.transaction_mode,transaction_info.date,service_provider_info.service_provider_name,bank_info.bank_name');
		$this->db->from('transaction_info,service_provider_info,bank_info,bank_book');
		$this->db->where('transaction_info.ledger_id =service_provider_info.service_provider_id'); 
		$this->db->where('transaction_info.transaction_id =bank_book.transaction_id'); 
	...
	{
		$this->db->select('transaction_info.transaction_id,transaction_info.transaction_purpose,transaction_info.remarks,transaction_info.amount,transaction_info.transaction_mode,transaction_info.date,service_provider_info.service_provider_name,bank_info.bank_name');
		$this->db->from('transaction_info,service_provider_info,bank_info,bank_book');
		$this->db->where('transaction_info.ledger_id =service_provider_info.service_provider_id'); 
		$this->db->where('transaction_info.transaction_id =bank_book.transaction_id'); 
		$this->db->where('bank_info.bank_id = bank_book.bank_id'); 
