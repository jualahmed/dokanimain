...
class Excel_model extends CI_Model{
	...
	public function print_data_stock()
	{
		...
		$this->db->select('product_name, product_info.product_id, bulk_unit_sale_price, bulk_unit_buy_price, stock_amount, barcode, group_name, product_info.product_specification,product_type,product_size');
	...
	public function print_data_stock2()
	{
		...
		if($type_wise !='' && $type_wise !='null')
		{
			...
			{
				$this->db->select('product_name, product_info.product_id, bulk_unit_sale_price, general_unit_sale_price, bulk_unit_buy_price, stock_amount, barcode, group_name, product_specification,product_type,product_size');
				$this->db->from('product_info');
				$this->db->join('bulk_stock_info','product_info.product_id = bulk_stock_info.product_id','left');
