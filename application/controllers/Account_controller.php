...
class Account_controller extends CI_controller{
	...
	function loan_transfer()
	{
		...
		$data['bank_info'] = $this -> account_model -> get_bank();				
		$this -> load -> view('Account/loan_transfer', $data);
	}
	function create_loan_transfer()
	{
		...
		if($transfer_id!=''){
			$data['status'] = 'success';
			redirect('account_controller/loan_transfer/success');
		}
		else{
			$data['status'] = 'failed';
			redirect('account_controller/loan_transfer/failed');
		}	
	}
	function loan_transfer_report()
	{
		$data['user_type'] = $this->tank_auth->get_usertype();
		$data['status'] = '';
		$timezone = "Asia/Dhaka";
		...
		$data['user_name'] = $this->tank_auth->get_username();
		$data['loan_person_info'] = $this -> account_model -> loan_person_info();		
		$this -> load -> view('Account/loan_transfer_report', $data);
	}
