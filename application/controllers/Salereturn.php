...
class Salereturn extends CI_controller
{
	...
	******************************/
	...
	function cash_salereturn()
	{
		$data['user_type'] 	= $this->tank_auth->get_usertype();
		$data['user_name'] 	= $this -> tank_auth -> get_username();
		$data['customer_info'] 	= $this->salereturn_model->getAllCustomerInfo();
		$data['product_info_warranty_details'] 	= '';
		$data['product_info_details'] 	= '';
		$data['return_main_product'] 	= $this -> salereturn_model -> return_main_product();
		$i=1;
		...
		$data['status'] 	= '';	
		$this -> load -> view('Salereturn/cash_salereturn', $data);
	}
