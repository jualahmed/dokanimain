...
<div class="wrapper">
	...
	<aside class="main-sidebar scrollbar-outer" style="max-height: 97vh!important">
		...
		{
		?>
			<li class="treeview <?php echo active_link_controller('expense') ?> <?php echo active_link_controller('loan') ?> <?php echo active_link_controller('damageproduct') ?><?php echo active_link_controller('bankcard') ?> <?php echo active_link_controller('comission') ?>  <?php echo active_link_controller('unit') ?> <?php echo active_link_controller('customer') ?> <?php echo active_link_controller('employee') ?> <?php echo active_link_controller('product') ?> <?php echo active_link_controller('distributor') ?> <?php echo active_link_controller('company') ?> <?php echo active_link_controller('category') ?>"  id="setup">
				<a href="#">
		...
		<li class="treeview <?php echo active_link_controller('Report') ?>">
					...
					<ul class="treeview-menu common">
						...
						<li class="<?php echo active_link_function('Report','quotation_report'); ?>">
							<a href="<?php echo base_url();?>Report/quotation_report"><i class="fa fa-search-plus"></i>Quotation Report</a>
						</li>
