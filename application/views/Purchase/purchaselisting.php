							...
							<table class="table table-bordered reduce_space">
								<tbody>
									<tr>
										...
										<td>
											<input type="number" @keyup="changeQuantity" min="1" class="form-control custom_form_control quantity" :class="[errors.quantity ? 'has-error' : '']" v-model="quantity" id="quantity" name="" placeholder="Ex: 10" autocomplete="off" required>
										</td>
									...
									<tr>
										...
										<td>
											<input type="number" @keyup="changeTotalBuyPrice" step="3" class="form-control custom_form_control total_buy_price" :class="[errors.total_buy_price ? 'has-error' : '']" v-model="total_buy_price" style="text-align: right;">
										</td>
									...
									<tr>
										...
										<td>
											<input type="number" @keyup="changeUnitBuyPricePurchase" step="3" class="form-control custom_form_control" :class="[errors.unit_buy_price_purchase ? 'has-error' : '']" v-model="unit_buy_price_purchase" style="text-align: right;" placeholder="Ex: 10" autocomplete="off">
										</td>
							...
							<div class="modal-body">
								...
								<table class="table table-bordered serial_qnt_price">
									...
									<tr>
										...
										<td>
											<input type="text" class="form-control" id="u_b_p" name="u_b_p" style="text-align: right;" placeholder="Ex: 10" readonly="true" autocomplete="off">
										</td>
									</tr>
									<tr>
										<td style="vertical-align: middle;"> General Sale Price: </td>
										<td>
											<input type="text" class="form-control" id="g_b_p" name="u_b_p" style="text-align: right;" placeholder="Ex: 10" readonly="true" autocomplete="off">
										</td>
									</tr>
									<tr>
										<td style="vertical-align: middle;">Exclusive Sale Price: </td>
										<td>
											<input type="text" class="form-control" id="e_b_p" name="u_b_p" style="text-align: right;" placeholder="Ex: 10" readonly="true" autocomplete="off">
										</td>
									</tr>
								</table>
							</div>
