...
<div class="content-wrapper">
	<style>
		...
		#product_listing_form th,
		#product_listing_form td {
			font-size: 12px;
		...
		#product_listing_form .form-control {
			height: 30px;
			padding: 2px 8px;
		}
	</style>
			...
			<div class="col-md-6">
				<div class="box">
					...
					<div class="box-body">
						<table class="table table-bordered reduce_space">
							<tbody>
								<tr style="">
									...
									<td colspan="3">
										<multiselect v-model="selected1" id="ajax" label="distributor_name" track-by="receipt_id" placeholder="Type to search Receipt" open-direction="bottom" :options="purchase_receipt_info" :searchable="true" :loading="isLoading" :internal-search="true" :clear-on-select="false" :close-on-select="true" :options-limit="300" :limit="3" :limit-text="limitText" :max-height="600" :show-no-results="false" :hide-selected="false">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="input-group input-group-md" style="background-color: #fff7bf;">
									<multiselect v-model="selectedCountries" id="ajax" label="product_name" track-by="product_name" placeholder="type product name" open-direction="bottom" :options="countries" :searchable="true" :loading="isLoading" :internal-search="false" :clear-on-select="false" :close-on-select="true" :options-limit="300" :limit="3" :disabled="selected1 == ''" :limit-text="limitText" :max-height="600" :show-no-results="false" :hide-selected="false" @search-change="asyncFind" @select="selectProduct">
							...
							<table class="table table-bordered reduce_space">
								<tbody>
									<tr>
										...
										<td>
											<input type="number" @keyup="calculateTotalUnit" v-model="unit_par_pack" min="1" class="form-control custom_form_control quantity" placeholder="Ex: 10" autocomplete="off">
										</td>
										<td style="vertical-align: middle;font-weight: bold;">
											Box TP
										</td>
										<td>
											<input type="number" @keyup="calculateUnitTP" v-model="price_per_pack" class="form-control custom_form_control quantity" placeholder="Ex: 00.00" autocomplete="off">
										</td>
									</tr>
									<tr>
										<td style="vertical-align: middle;font-weight: bold;">Box MRP:</td>
										<td style="text-align: right;">
											<input type="number" step="3" @keyup="calculateUnitMRP" class="form-control custom_form_control quantity" :class="[errors.pack_mrp ? 'has-error' : '']" v-model="pack_mrp" style="text-align: right;" placeholder="Ex: 00.00" autocomplete="off" required>
										</td>
										<td style="vertical-align: middle;font-weight: bold;">
											Total Box:
										</td>
										<td>
											<input type="number" @keyup="calculateTotalUnit" v-model="total_pack" min="1" class="form-control custom_form_control quantity" placeholder="Ex: 10" autocomplete="off">
										</td>
									...
									<tr>
										...
										<td>
											<input type="number" @keyup="calculateTotalTP" style="background-color: #fff7bf;color:#000000;font-weight: bold;" :class="[errors.total_unit ? 'has-error' : '']" v-model="total_unit" class="form-control custom_form_control quantity" placeholder="Ex: 10" autocomplete="off">
										</td>
										<td style="vertical-align: middle;font-weight: bold;">
											Total TP:
										</td>
										<td>
											<input type="number" @keyup="calculatePriceParUnit" v-model="total_tp" min="1" style="background-color: #fff7bf;color:#000000;font-weight: bold;" class="form-control custom_form_control quantity" placeholder="Ex: 10.00" autocomplete="off">
										</td>
									...
									<tr>
										<td style="vertical-align: middle;font-weight: bold;">
											Discount:
											<span style="margin-right: 10px;"><input type="radio" @change="calculateDiscount" v-model="discount_type" value="0"> Tk. </span>
											<span><input type="radio" @change="calculateDiscount" v-model="discount_type" value="1"> %</span>
										</td>
										<td style="text-align: center;vertical-align: middle;font-weight: bold;">

											<input type="number" @keyup="calculateDiscount" v-model="discount_amount" class="form-control custom_form_control quantity" placeholder="Ex: 10" autocomplete="off">

										</td>
										<td style="vertical-align: middle;font-weight: bold;">
											VAT:
											<span style="margin-right: 10px;"><input type="radio" @change="calculateVat" v-model="vat_type" value="0"> Tk.</span>
											<span><input type="radio" @change="calculateVat" v-model="vat_type" value="1"> %</span>
										</td>
										<td colspan="2" style="text-align: center;vertical-align: middle;font-weight: bold;">

											<input type="number" @keyup="calculateVat" v-model="vat_amount" class="form-control custom_form_control quantity" placeholder="Ex: 10" autocomplete="off">
										</td>
									</tr>
								</tbody>
							</table>
								...
								<tbody>
									...
									?>
										<tr>
											...
											<td>
												<input type="number" class="form-control custom_form_control tp_total quantity" v-model="tp_total" style="text-align: right;" id="tp_total" name="" placeholder="Ex: 10" autocomplete="off">
											</td>
											<td style="vertical-align: middle;font-weight: bold;">VAT:</td>
											<td>
												<input type="number" class="form-control custom_form_control vat_total quantity" v-model="vat_total" style="text-align: right;" id="vat_total" name="" placeholder="Ex: 10" autocomplete="off">
											</td>
										</tr>
									<?php } ?>
									<tr>
										...
										<td>
											<input type="number" step="3" class="form-control custom_form_control unit_buy_price_purchase quantity" readonly placeholder="Ex: 00.00" v-model="total_tp_after_vat" style="text-align: right;">
										</td>
										<td style="vertical-align: middle;font-weight: bold;">
											Unit Buy Price:
										</td>
										<td>
											<input type="number" style="background-color: #fff7bf;color:#000000;font-weight: bold;" @keyup="changeTotalBuyPrice" step="3" class="form-control custom_form_control unit_buy_price_purchase quantity" :class="[errors.unit_buy_price_purchase ? 'has-error' : '']" placeholder="Ex: 00.00" v-model="unit_buy_price_purchase" style="text-align: right;">
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<input type="number" style="background-color: #fff7bf;color:#000000;font-weight: bold;" @keyup="changeUnitBuyPricePurchase" step="3" class="form-control custom_form_control quantity" :class="[errors.general_sale_price ? 'has-error' : '']" v-model="general_sale_price" style="text-align: right;" placeholder="Ex: 00.00" autocomplete="off">
										</td>
										<td style="width: 20%; vertical-align: middle;font-weight: bold;">Unit Shop Sale Price:</td>
										<td>
											<input type="number" step="3" style="background-color: #fff7bf;color:#000000;font-weight: bold;" class="form-control custom_form_control quantity" :class="[errors.exclusive_sale_price ? 'has-error' : '']" v-model="exclusive_sale_price" style="text-align: right;" placeholder="Ex: 00.00" autocomplete="off">
										</td>
									</tr>
								</tbody>
							</table>
							...
							<table class="head" id="purchase_products">
								...
								<tr v-for="(p,index) in purchase_info[0]" :key="index">
									...
									<td style="text-align: center;width: 6%;">
										<i data-toggle="modal" data-target="#edit_modal" class="fa fa-fw fa-edit css_for_cursor" style="color: #db8b0b; " name="edit" title="Edit" :id="p.product_id" :purchase_id="p.purchase_id"></i>
										<i class="fa fa-fw fa-remove css_for_cursor" style="color: red; " @click="removePurchaseItem(p.purchase_id)" name="remove" title="Remove"></i>
									</td>
								</tr>
								<tr style="background-color: #2aabd2; color: white;">
									<td style="width: 4%;"></td>
