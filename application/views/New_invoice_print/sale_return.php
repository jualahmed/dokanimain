...
<script type="text/javascript">
	...
	<body> 
		...
		<div id= "main_container_body">
			...
			?>
			<div class ="pos_top_header_second"><?php $row_data = $sale_return_info->row(); ?>
				<div class ="pos_top_header_second_left" style="font-weight: bold; ">Return Invoice : <?php echo $row_data->sale_return_id; ?></div>
			...
			<div class ="pos_top_header_second">
				<div id ="pos_top_header_second_right" style="font-weight: bold; ">Date : <?php $newDate = date("d-m-Y", strtotime($row_data->sale_return_doc));echo $newDate; ?></div>
			...
			<?php
				if($sale_return_info -> num_rows() > 0) 
				{
			?>
				<div class="CSSTableGenerator" style="width:100%;margin:0px auto;float:left">
					<table >	
						...
						<?php
							$save1 = 0;
							$final_total = 0;
							foreach ($sale_return_info -> result() as $field):
						?>
						<tr>
							...
							<td style="width:10%;text-align:right;">
								<?php 
									echo '<big style = "font-size: 11px; font-weight:bold;"> &#2547; </big> '.$field-> unit_sale_price;
								?> 
							</td>
							<td style="width:12%;text-align:right;border-right:0px solid black;">
								<?php 
									echo '<big style = "font-size: 11px; font-weight:bold;"> &#2547; </big> '.$field -> return_quantity * $field-> unit_sale_price;
									$final_total+=$field -> return_quantity * $field-> unit_sale_price;
								?> 
							</td>
						</tr>
						<?php
			...
			<div id ="pos_top_header_fourth" style="width: 50%; float: right;">
				...
				<div class ="pos_top_header_fourth_right"> <?php echo $final_total;?></div>
			</div>
