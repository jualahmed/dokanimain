		...
		<div id= "main_container_body">
			...
			<!--div id ="pos_top_header_fourth" style="width: 50%;float: left; height:140px;">
				<div style="height:70px;">
					<?php 
					$row_data2 = $card_info->row();
					$card_name = $row_data2->card_name;				
					?>
					<div style="width:50%;"> Payment By </div>
					<?php if($card_name =='MASTER'){?>
					<div style="width:50%;"><img src="<?php echo base_url();?>assets/assets2/dist/img/credit/mastercard.png" alt="<?php echo $card_name;?>"></div>
					<?php } else if($card_name =='VISA'){?>
					<div style="width:50%;"><img src="<?php echo base_url();?>assets/assets2/dist/img/credit/visa.png" alt="<?php echo $card_name;?>"></div>
					<?php } else if($card_name =='AMERICAN EXPRESS'){?>
					<div style="width:50%;"><img src="<?php echo base_url();?>assets/assets2/dist/img/credit/american-express.png" alt="<?php echo $card_name;?>"></div>
					<?php }?>
				</div>
				<div style="height:70px;">
					<?php if(($save1+$row_data->discount_amount +$row_data->discount) > 0){ ?><center><span style = "font-weight:bold;font-size: 16px;"><?php echo $save1+$row_data->discount_amount +$row_data->discount;?>&#2547; </span> <br /><span style="font-size: 16px;">সাশ্রয় হল । </span></b></center> <?php } ?>
				</div>
			</div-->
