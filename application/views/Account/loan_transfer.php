		...
		<div class="col-md-8 col-md-offset-2">
			<div class="box">
				<div class="box-header with-border" style="background: #0f77ab;">
					<h3 class="box-title" style="color:white;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;">Loan Transfer</h3>
				</div>
				<form action="<?php echo base_url();?>account_controller/create_loan_transfer" method="post" class="form-horizontal">
					<div class="box-body">	
...
<div class="modal fade" id="show_loan_person_modal" >
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form id="add_loan_person_form" action="<?php echo base_url(); ?>registration_controller/create_loan_person" method="post" autocomplete="off" enctype="multipart/form-data" role="form">
