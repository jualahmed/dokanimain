			...
			<div class="col-md-10 col-md-offset-1">
				<div class="box">
					<div class="box-header with-border" style="background: #0f77ab;">
						<h3 class="box-title" style="color:white;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;">Loan Transfer Report</h3>
					</div>
					<div class="box-body">
						<form action ="<?php echo base_url();?>account_controller/all_loan_transfer_report_find" method="post" class="form-horizontal" autocomplete="off" enctype="multipart/form-data" id="form_6">
							<div class="form-group">
								...
								<div class="col-sm-3">
									...
									<a href="<?php echo base_url();?>account_controller/download_loan_transfer" id="down" style="display:none;width:100px;" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-download"></i> Download</a>
								</div>
							</div>
						</form>
					</div>
...
$(document).ready(function() {
		...
		$.ajax({
			...
			success: function(result) {	
				...
				{	
					...
					//alert(total_amount1);
					output2+='<table><tr><td style="width: 4%;">'+result['credit'][i].date+'</td><td style="width: 4%;">'+result['credit'][i].loan_person_name+'</td><td style="width: 4%;">'+result['credit'][i].transaction_purpose+'</td><td style="overflow: hidden;text-overflow: ellipsis; white-space: nowrap;width: 4%;text-align:right;">'+amount1.toFixed(2)+'</td></tr></table>';
				...
				{	
					...
					output3+='<table class="new_data_2"><tr><td style="width: 4%;">'+result['debit'][k].date+'</td><td style="width: 4%;">'+result['debit'][k].loan_person_name+'</td><td style="width: 4%;">'+result['debit'][k].transaction_purpose+'</td><td style="overflow: hidden;text-overflow: ellipsis; white-space: nowrap;width: 4%;text-align:right;">'+amount2.toFixed(2)+'</td></tr></table>';
				}
	...
	$("#down").click(function(event2) 
	{
		...
		var lp_id = $("#lp_id").val();
		window.open(submiturl+'/'+lp_id,'_blank');
	});
