		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				<div class="box">
					...
					<div class="box-body">
						<form action ="<?php echo base_url();?>account_controller/all_bank_book_report_find" method="post" class="form-horizontal" autocomplete="off" enctype="multipart/form-data" id="form_6">
							<div class="form-group">
								...
								<div class="col-sm-4">
									...
									<a href="<?php echo base_url();?>account_controller/download_bank_book" id="down" style="display:none;width:100px;" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-download"></i> Download</a>
								</div>
							</div>
						</form>
					</div>
