		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<div class="box box-info">
					...
					<form action="<?php echo base_url();?>account_controller/create_investment" method="post" class="form-horizontal">
						<div class="box-body">
...
<div class="modal fade" id="show_investor_modal">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form id="add_investor_form" action="<?php echo base_url(); ?>registration_controller/create_investor" method="post" autocomplete="off" enctype="multipart/form-data" role="form">
