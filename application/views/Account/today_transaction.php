				...
				{	
					...
					else if(transaction_purposes=='expense')
					{
						...
						{	
							...
							output_expense+='<tr><td style="width: 4%;">'+kkkkkk+'</td><td style="width: 4%;">'+result['transaction6'][ii].date+'</td><td style="width: 4%;">'+result['transaction6'][ii].expense_details+'</td><td style="width: 4%;">'+result['transaction6'][ii].type_type+'</td><td style="overflow: hidden;text-overflow: ellipsis; white-space: nowrap;width: 4%;text-align:right;">'+amount1.toFixed(2)+'</td></tr>';
							kkkkkk++;
						}
					}
					else if(transaction_purposes=='expense_payment')
					{
						...
						{	
							...
							output_expense_payment+='<tr><td style="width: 4%;">'+kkkkkkk+'</td><td style="width: 4%;">'+result['transaction7'][ii].date+'</td><td style="width: 4%;">'+result['transaction7'][ii].expense_details+'</td><td style="width: 4%;">'+result['transaction7'][ii].type_type+'</td><td style="overflow: hidden;text-overflow: ellipsis; white-space: nowrap;width: 4%;text-align:right;">'+amount1.toFixed(2)+'</td></tr>';
							kkkkkkk++;
						}
					}
				}
