		...
		<div class="row">
			<div class="col-md-7 col-md-offset-3">
				<div class="box">
					...
					<div class="box-body">
						<form action ="<?php echo base_url();?>modify_controller/all_card_report_find" method="post" class="form-horizontal" enctype="multipart/form-data" id="form_4">
...
$(document).ready(function() {
		...
		$(document).on("click", ".btnEdit", function() {
			...
			function editr(par) 
			{
				...
				var urlx='<?php echo base_url();?>modify_controller/card_info_edit';
			...
			var urlx='<?php echo base_url();?>modify_controller/save_card_info_edit';
