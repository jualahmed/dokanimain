					...
					<div class="wrap">
						<table class="head">
							<tr>
								...
								<td style="width:54px;text-align:center;"> Quantity  </td>
								<td style="width:48px;text-align:center;"> Buy </td>
								<td style="width:48px;text-align:center;"> Sale </td>
								<td style="width:48px;text-align:center;"> Ex. Sale </td>
...
<script type="text/javascript">
	...
	$(document).on("click", "#submit_btn", function()
	{
		...
		$.ajax({
			...
			type: 'POST',
			dataType: 'json',
			data: {'hid':hid,'product':product,'product_size':product_size,'product_model':model,'company':company,'catagory':catagory,'unit':unit,'barcode':barcode,'quantity':quantity,'buy_price':buy_price,'sale_price':sale_price,'ex_sale_price':ex_sale_price},
			success:function(result)
			{
				if(id_barcode==''){
					id_barcode='null';
