		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				<div class="box">
					...
					<div class="box-body">
						<form action ="<?php echo base_url();?>modify_controller/get_invoice_info_modify" class="form-horizontal" method="post" enctype="multipart/form-data" id="form_4">
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-2 control-label">Invoice ID</label>
								<div class="col-sm-3">
									<input type="text" name="invoice_id" class="form-control" id="invoice_id" placeholder="Invoice ID" tabindex="3" title="Invoice ID">
			...
			<div class="col-md-12">
				<div class="box">
					<div class="box-body">
						<div class="input-group input-group-md">
							<span class="input-group-addon">Invoice</span>
							<input type="text" class="form-control" id="search_invoice" placeholder="Search for Invoice.." title="Type in a name">
						</div>
						<div class="wrap">
							<table class="head">
								<tr>
	...
	$("#form_4").submit(function(event) 
	{
		...
		$.ajax({
			...
			success: function(result) {	
				$(".modal1234").hide();
				for(i=0; i<result.length; i++){	  
					output2+='<table class="new_data_2" id="myTable"><tr><td style="text-align:center;">'+k+'</td><td style="text-align:center;">'+result[i].invoice_id+'</td><td style="text-align:center;overflow: hidden;text-overflow: ellipsis; white-space: nowrap;" title="'+result[i].invoice_doc+'">'+result[i].invoice_doc+'</td><td style="overflow: hidden;text-overflow: ellipsis; white-space: nowrap;text-align:center;" title="'+result[i].total_price+'" >'+result[i].total_price+'</td><td style="overflow: hidden;text-overflow: ellipsis; white-space: nowrap;text-align:center;" title="'+result[i].user_full_name+'" >'+result[i].user_full_name+'</td><td style="text-align:center;"><a href="<?php echo base_url();?>modify_controller/modify_single_invoice/'+result[i].invoice_id+'" target="_blank" class="btnEdit" style="cursor:pointer;"><i class="fa fa-fw fa-edit"></i></a></tr></table>';
					k++;
				}
				if(output2 != '')
				{
