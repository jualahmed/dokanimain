		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				<div class="box">
					...
					<div class="box-body">
						<form action ="<?php echo base_url();?>modify_controller/get_damage_info_modify" class="form-horizontal" autocomplete="off" method="post" enctype="multipart/form-data" id="form_4">
...
function editr(par) 
{
	...
	var urlx='<?php echo base_url();?>modify_controller/damage_info_edit';
	var id=td_Id.html();
	$.ajax({
		url: urlx,
		type: 'POST',
...
function saver(par) 
{
	...
	var urlx='<?php echo base_url();?>modify_controller/save_damage_info_edit';
	var hid=td_Id.html();
...
function deleter(par) 
{
	...
	var td_product_id = par.children("td:nth-child(3)");
	var td_quantity = par.children("td:nth-child(6)");
	var urlx='<?php echo base_url();?>modify_controller/delete_damage';
	var id=td_Id.html();
		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				<div class="box">
					...
					<div class="box-body">
						<form action ="<?php echo base_url();?>modify_controller/get_damage_info_modify" class="form-horizontal" method="post" enctype="multipart/form-data" id="form_4">
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-1 control-label">Start</label>
								<div class="col-sm-3">
									<input type="text" name="start_date" class="form-control" id="datepickerrr" placeholder="Star Date" tabindex="3" title="Start Date">
