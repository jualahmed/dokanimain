			...
			<div class="col-md-10 col-md-offset-1">
				<div class="box">
					<div class="box-header with-border" style="background: #0f77ab;">
						<h3 class="box-title" style="color:white;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;">Financial Statement Report</h3>
					</div>
					<div class="box-body">
						<form action ="<?php echo base_url();?>report_controller/specific_date_report_for_financial_statement_1" class="form-horizontal" method="post" enctype="multipart/form-data" id="form_3" autocomplete="off">
