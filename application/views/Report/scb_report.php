			...
			<div class="col-md-10 col-md-offset-1">
				<div class="box">
					<div class="box-header with-border" style="background: #0f77ab;">
						<h3 class="box-title" style="color:white;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;">SCB Search</h3>
					</div>
					<div class="box-body">
						<form action ="<?php echo base_url();?>report_controller/scb_report" method="post" enctype="multipart/form-data" id="form_3" class="form-horizontal" autocomplete="off">
							<div class="form-group">
								...
								<div class="col-sm-4">
									...
									<a href="<?php echo base_url();?>report_controller/download_scb_report/<?php echo $this->uri->segment(3);?>/<?php echo $this->uri->segment(4);?>" target="_blank" class="btn btn-primary btn-sm" style="text-decoration:none;"><i class="fa fa-download"></i> Down</a>
								</div>
							</div>
						</form>	
					</div>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table class="table table-bordered">
                ...
                <tr>
                  <td>Opening Stock (+)</td>
                  <td style="text-align:right;"><?php echo sprintf('%0.2f',$opening_stock); ?></td>
                </tr>
				<tr>
                  <td>Purchase (+)</td>
				...
				<tr>
                  <td>Sale Return (+)</td>
                  <td style="text-align:right;"><?php echo sprintf('%0.2f',$sale_return_info);?></td>
                </tr>
				<tr>
                  <td>Closing Stock</td>
                  <td style="text-align:right;"><?php echo sprintf('%0.2f',$opening_stock+$purchase_total_amount-$purchase_return_info-$sale_price_info+$sale_return_info);?></td>
                </tr>
              </tbody>
			  </table>
            </div>
