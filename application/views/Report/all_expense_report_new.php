		...
		<div class="row">
			<div class="col-md-12">
				<div class="box">
					...
					<div class="box-body">
						<form action ="<?php echo base_url();?>report_controller/all_expense_report_find" method="post" autocomplete="off" enctype="multipart/form-data" id="form_6" class="form-horizontal">
							<div class="form-group">
								...
								<div class="col-sm-3">
									...
									<a href="<?php echo base_url();?>report_controller/download_data_expense" id="down" style="display:none;" target="_blank" class="btn btn-primary  btn-sm"><i class="fa fa-download"></i> Download</a>
								</div>
							</div>
						</form>
					</div>
		...
		$.ajax({
			...
			success: function(result) {	
				...
				for(i=0; i<result.length; i++){		
					...
					output2+='<table class="new_data_2"><tr><td>'+k+'</td><td>'+result[i].expense_doc+'</td><td>'+result[i].expense_id+'</td><td style="overflow: hidden;text-overflow: ellipsis; white-space: nowrap;" title="'+result[i].expense_type+'">'+result[i].expense_type+'</td><td>'+result[i].service_provider_name+'</td><td style="text-align:right;">'+expense_amount+'</td></tr></table>';
					k++;
				}
				if(output2 != '')
				{
