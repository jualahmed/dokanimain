      ...
      $.ajax({
        ...
        success: function (result) {
          ...
          for (var ii = 0; ii < result["sale_return"].length; ii++) {
            var sale_retrun_amount = parseFloat(
              result["sale_return"][ii].sale_retrun_amount
            );
          }
          ...
          $("#ledger_amount_collection").html(
            parseFloat(balance_amount).toFixed(2)
          );
          $("#ledger_amount_sale_return").html(
            parseFloat(sale_retrun_amount).toFixed(2)
          );
          var totbalac =
            parseFloat(balance_amount) + parseFloat(sale_retrun_amount);
  
          $("#ledger_amount_balance").html(
            parseFloat(sale_amount - totbalac).toFixed(2)
          );
          ...
          if (tot_return_price > tot_return_balance_price) {
            var return_adjustment_amount =
              parseFloat(tot_return_price) - parseFloat(tot_return_balance_price);
