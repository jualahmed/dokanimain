		...
		<div id="main_container_body_main2">
			<div class="main_container_body">
				<div class="text-center">
					...
					<?php $row_data = $purchase_payment_info->row(); ?>
					...
					<p style="margin: 0px;">Distributor : <?php echo $row_data->distributor_name; ?></p>
				</div>

				<div id="pos_top_header_thired">
					<?php
					if ($purchase_payment_info->num_rows() > 0) {
					?>
						<div class="CSSTableGenerator" style="width:100%;margin:0px auto;float:left">
							<table>
								...
								<?php
								foreach ($purchase_payment_info->result() as $field) :
								?>
									<tr>
