<div class="content-wrapper" id="vuejsapp">
	<section class="content text-right">
		...
		<div class="row">
			<div class="col-sm-4">
				<input type="text" v-model="search" @keyup="paginateData" class="form-control product_name" id="search" placeholder="Search By Name/Contact No.">
			</div>
		</div>
		<br>
		<br>
		<table class="table table-bordred table-striped" align="left">
			...
			<tr v-for="(r,index) in result" align="left" :key="index">
				<td>{{ row+index+1 }}</td>
			...
			<tr>
				<td colspan="9" style="text-align: left;"><b>{{ rowperpage }} Out Of {{ total }}</b></td>
			</tr>
		</table>
