			...
			<div id="controller">
				<htmlpageheader name="myheader">
					<div id="header">
						...
						<h3 class="pageTitleSmall" style="margin:10px 0px 5px 0px;"> Distributor Report </h3>
					</div>
				</htmlpageheader>
					...
					<table class="simpleTable" style="margin-top:30px;">
						<thead>
							<tr class="tableRowBG">
								...
								<th colspan="3" style="color:black;">Id</th>
						...
						<?php
						$index = 1;
						foreach($down_data_distributor -> result() as $field):
						?>
							<tr>
								<th colspan="3"> <?php echo $index; ?>  </th>
								<th colspan="3"> <?php echo $field->distributor_id; ?>  </th>
								<th colspan="3"> <?php echo $field->distributor_name; ?>  </th>
								<th colspan="3"> <?php echo $field->distributor_contact_no; ?>  </th>
								<th colspan="3"> <?php echo $field->distributor_email; ?>  </th>
								<th colspan="3" style="text-align:left;"> <?php echo $field->distributor_address; ?>  </th>
								<th colspan="3" style="text-align:left;"> <?php echo $field->distributor_description; ?>  </th>
