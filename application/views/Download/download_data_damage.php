			...
			<div id="controller">
				<htmlpageheader name="myheader">
					<div id="header">
						...
						<h3 class="pageTitleSmall" style="margin:10px 0px 5px 0px;"> Damage Report </h3>
					</div>
				</htmlpageheader>
					...
					<table class="simpleTable" style="margin-top:15px;">
						<thead>
							<tr class="tableRowBG">
								...
								<th colspan="3" style="text-align:center;">P.ID</th>
								<th colspan="6" style="text-align:left;">Company</th>
								<th colspan="6" style="text-align:left;">Category</th>
								<th colspan="6" style="text-align:left;">Product</th>
								<th colspan="6" style="text-align:center;">Quantity</th>
								<th colspan="6" style="text-align:right;">BP</th>
							</tr>
						</thead>	
						<tbody>	
						<?php
						...
						$damage_quantity = 0;
						$buy_price = 0;
						foreach($download_data_damage -> result() as $field):
						?>
							<tr>
								<th colspan="3" style="text-align:center;"> <?php echo $index; ?>  </th>
								<th colspan="3" style="text-align:center;"> <?php echo $field->doc; ?>  </th>
								<th colspan="3" style="text-align:center;"> <?php echo $field->product_id; ?>  </th>
								<th colspan="6" style="text-align:left;"> <?php echo $field->company_name; ?> </th>
								...
								<th colspan="6" style="text-align:center;"> <?php echo $field->damage_quantity; ?> </th>
								<th colspan="6" style="text-align:right;"> <?php echo  sprintf('%0.2f',$field -> unit_buy_price); ?> </th>
							</tr>
						<?php
							$damage_quantity+=$field->damage_quantity;
							$buy_price+=$field->damage_quantity * $field->unit_buy_price;
							$index++;
							endforeach;
					...
					<table class="simpleTable" style="margin-top:30px;">
						<thead>
							<tr class="tableRowBG">
								...
								<th colspan="3" style="text-align:center;">Total Damage</th>
							</tr>
						</thead>	
						<tbody>	
							<tr>
								<th colspan="3" style="text-align:center;"> <?php echo $damage_quantity; ?>  </th>
								<th colspan="3" style="text-align:center;"> <?php echo sprintf('%0.2f',$buy_price); ?>  </th>
							</tr>
						</tbody>
					</table>
				</div>
