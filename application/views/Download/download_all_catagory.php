			...
			<div id="controller">
				<htmlpageheader name="myheader">
					<div id="header">
						...
						<h3 class="pageTitleSmall" style="margin:10px 0px 5px 0px;"> Catagory Report </h3>
					</div>
				</htmlpageheader>
					...
					<table class="simpleTable" style="margin-top:30px;">
						<thead>
							<tr class="tableRowBG">
								...
								<th colspan="3" style="color:black;">Catagory Id</th>
								<th colspan="3" style="text-align:left;color:black;">Catagory Name</th>
								<th colspan="3" style="text-align:left;color:black;">Catagory Description</th>
							</tr>
						</thead>	
						<tbody>	
						<?php
						$index = 1;
						foreach($down_data_catagory -> result() as $field):
						?>
							<tr>
								<th colspan="3"> <?php echo $index; ?>  </th>
								<th colspan="3"> <?php echo $field->catagory_id; ?>  </th>
								<th colspan="3"> <?php echo $field->catagory_name; ?>  </th>
								<th colspan="3" style="text-align:left;"> <?php echo $field->catagory_description; ?>  </th>
							</tr>
						<?php
							$index++;
							endforeach;
