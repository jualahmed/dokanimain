...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>style/transcript_style.css"/> 
	</head>
	
	<body>
		<div id="main100">
			<div id="controller100">
				<htmlpageheader name="myheader">
					<div id="header">
						...
						<h3 class="pageTitleSmall" style="margin:10px 0px 5px 0px;"> Investment Report </h3>
					</div>
				</htmlpageheader>
					...
					<table class="simpleTable" style="margin-top:30px;">
						<thead>
							<tr class="tableRowBG" >
								...
								<th colspan="6" style="text-align:center;">Investment Details</th>
								<th colspan="6" style="text-align:right;">Investment Amount</th>
							</tr>
						</thead>
						...
						<tbody>
							<?php
							$index = 1;
							foreach($download_data_investment -> result() as $field):
							?>
								<tr>
									<th colspan="3"> <?php echo $index; ?>  </th>
									<th colspan="3"> <?php echo $field->investment_doc; ?>  </th>
									<th colspan="3"> <?php echo $field->investor_name; ?>  </th>
									<th colspan="6" style="text-align:center;"> <?php echo $field->investment_details; ?>  </th>
									<th colspan="6" style="text-align:right;"> <?php echo sprintf('%0.2f',$field->investment_amount); ?> </th>
								</tr>
							<?php
								$index++;
								endforeach;
