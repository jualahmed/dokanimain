			...
			<div id="controller">
				<htmlpageheader name="myheader">
					<div id="header">
						...
						<h3 class="pageTitleSmall" style="margin:10px 0px 5px 0px;"> Card Sale Report </h3>
					</div>
				</htmlpageheader>
					...
					<table class="simpleTable" style="margin-top:15px;">
						<thead>
							<tr class="tableRowBG">
								...
								<th colspan="3" style="text-align:left;">Card Name</th>
								<th colspan="3" style="text-align:center;">Bank Name</th>
								<th colspan="6" style="text-align:right;">Sale Amount</th>
							</tr>
						</thead>	
						<tbody>	
						<?php
						$index = 1;
						$grand_sale=0;
						foreach($download_data_card_sale -> result() as $field):
						?>
							<tr>
								<th colspan="3" style="text-align:center;"> <?php echo $index; ?>  </th>
								<th colspan="3" style="text-align:center;"> <?php echo $field->date; ?>  </th>
								<th colspan="3" style="text-align:left;"> <?php echo $field->card_name; ?>  </th>
								<th colspan="3" style="text-align:center;"> <?php echo $field->bank_name; ?>  </th>
								<th colspan="6" style="text-align:right;"> <?php echo sprintf('%0.2f',$field ->amount); ?> </th>

								<?php $grand_sale += $field -> amount;?>
							</tr>
						<?php
							$index++;
							endforeach;
