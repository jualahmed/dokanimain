		...
		<div class="row">
			<div class="col-md-12">
				<div class="box">
					...
					<div class="box-body">
						<form action ="<?php echo base_url();?>account_controller/all_investment_report_find" class="form-horizontal" method="post" autocomplete="off" enctype="multipart/form-data" id="form_6">
							<div class="form-group">
								...
								<div class="col-sm-3">
									...
									<a href="<?php echo base_url();?>account_controller/download_data_investment" id="down" style="display:none;" target="_blank" class="btn btn-primary  btn-sm"><i class="fa fa-download"></i> Download</a>
								</div>
							</div>
						</form>
					</div>
