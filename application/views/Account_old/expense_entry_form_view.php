						...
						<div class="box-body">	
							<div class="form-group">
								...
								<div class="col-sm-4">
									<div class="input-group input-group-md">
										<?php 	
											echo form_dropdown('service_provider_id', $service_provider_info, '' ,'class="form-control select22 service_provider_name" id="two" style="width: 100%;"tabindex="-1" aria-hidden="true"');
										?>
										<span class="input-group-btn">
