...
$(document).ready(function() {
		...
		$.ajax({
			...
			success: function(result) {	
				...
				{	
					...
					if(transaction_purposes=='sale')
					{
						...
						{	
							...
							output_sale+='<tr><td style="width: 4%;">'+k+'</td><td style="width: 4%;">'+result['transaction2'][ii].date+'</td><td style="width: 4%;">'+result['transaction2'][ii].customer_name+'</td><td style="width: 4%;">'+result['transaction2'][ii].transaction_purpose+'</td><td style="overflow: hidden;text-overflow: ellipsis; white-space: nowrap;width: 4%;text-align:right;">'+amount1.toFixed(2)+'</td></tr>';
							k++;
						}
					}
					else if(transaction_purposes=='collection')
					{
						...
						{	
							...
							output_collection+='<tr><td style="width: 4%;">'+kk+'</td><td style="width: 4%;">'+result['transaction'][ii].date+'</td><td style="width: 4%;">'+result['transaction'][ii].customer_name+'</td><td style="width: 4%;">'+result['transaction'][ii].transaction_purpose+'</td><td style="overflow: hidden;text-overflow: ellipsis; white-space: nowrap;width: 4%;text-align:right;">'+amount1.toFixed(2)+'</td></tr>';
							kk++;
						}
					}
					...
					else if(transaction_purposes=='credit_collection')
					{
						...
						{	
							...
							output_credit_collection+='<tr><td style="width: 4%;">'+kkk+'</td><td style="width: 4%;">'+result['transaction3'][ii].date+'</td><td style="width: 4%;">'+result['transaction3'][ii].customer_name+'</td><td style="width: 4%;">'+result['transaction3'][ii].transaction_purpose+'</td><td style="overflow: hidden;text-overflow: ellipsis; white-space: nowrap;width: 4%;text-align:right;">'+amount1.toFixed(2)+'</td></tr>';
							kkk++;
						}
					}
					else if(transaction_purposes=='purchase')
					{
						...
						{	
							...
							output_purchase+='<tr><td style="width: 4%;">'+kkkk+'</td><td style="width: 4%;">'+result['transaction4'][ii].date+'</td><td style="width: 4%;">'+result['transaction4'][ii].distributor_name+'</td><td style="width: 4%;">'+result['transaction4'][ii].transaction_purpose+'</td><td style="overflow: hidden;text-overflow: ellipsis; white-space: nowrap;width: 4%;text-align:right;">'+amount1.toFixed(2)+'</td></tr>';
							kkkk++;
						}
					}
					else if(transaction_purposes=='payment')
					{
						...
						{	
							...
							output_purchase_payment+='<tr><td style="width: 4%;">'+kkkkk+'</td><td style="width: 4%;">'+result['transaction5'][ii].date+'</td><td style="width: 4%;">'+result['transaction5'][ii].distributor_name+'</td><td style="width: 4%;">'+result['transaction5'][ii].transaction_purpose+'</td><td style="overflow: hidden;text-overflow: ellipsis; white-space: nowrap;width: 4%;text-align:right;">'+amount1.toFixed(2)+'</td></tr>';
							kkkkk++;
						}
					}
					else if(transaction_purposes=='expense')
					{
						...
						{	
							...
							output_expense+='<tr><td style="width: 4%;">'+kkkkkk+'</td><td style="width: 4%;">'+result['transaction6'][ii].date+'</td><td style="width: 4%;">'+result['transaction6'][ii].service_provider_name+'</td><td style="width: 4%;">'+result['transaction6'][ii].expense_type+'</td><td style="overflow: hidden;text-overflow: ellipsis; white-space: nowrap;width: 4%;text-align:right;">'+amount1.toFixed(2)+'</td></tr>';
							kkkkkk++;
						}
					}
					else if(transaction_purposes=='expense_payment')
					{
						...
						{	
							...
							output_expense_payment+='<tr><td style="width: 4%;">'+kkkkkkk+'</td><td style="width: 4%;">'+result['transaction7'][ii].date+'</td><td style="width: 4%;">'+result['transaction7'][ii].service_provider_name+'</td><td style="width: 4%;">'+result['transaction7'][ii].expense_type+'</td><td style="overflow: hidden;text-overflow: ellipsis; white-space: nowrap;width: 4%;text-align:right;">'+amount1.toFixed(2)+'</td></tr>';
							kkkkkkk++;
						}
					}
				}
				output_collection_sum+='<tr><td style="width:4%;"></td><td style="width:4%;"></td><td style="width:4%;"></td><td style="width:4%;">Total</td><td style="width: 4%;text-align:right;">'+total_amount_collection.toFixed(2)+'</td></tr>';
				...
				output_credit_collection_sum+='<tr><td style="width:4%;"></td><td style="width:4%;"></td><td style="width:4%;"></td><td style="width:4%;">Total</td><td style="width: 4%;text-align:right;">'+total_amount_credit_collection.toFixed(2)+'</td></tr>';
				output_purchase_sum+='<tr><td style="width:4%;"></td><td style="width:4%;"></td><td style="width:4%;"></td><td style="width:4%;">Total</td><td style="width: 4%;text-align:right;">'+total_amount_purchase.toFixed(2)+'</td></tr>';
				output_purchase_payment_sum+='<tr><td style="width:4%;"></td><td style="width:4%;"></td><td style="width:4%;"></td><td style="width:4%;">Total</td><td style="width: 4%;text-align:right;">'+total_amount_purchase_payment.toFixed(2)+'</td></tr>';
				output_expense_sum+='<tr><td style="width:4%;"></td><td style="width:4%;"></td><td style="width:4%;"></td><td style="width:4%;">Total</td><td style="width: 4%;text-align:right;">'+total_amount_expense.toFixed(2)+'</td></tr>';
				output_expense_payment_sum+='<tr><td style="width:4%;"></td><td style="width:4%;"></td><td style="width:4%;"></td><td style="width:4%;">Total</td><td style="width: 4%;text-align:right;">'+total_amount_expense_payment.toFixed(2)+'</td></tr>';
